...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { code: @solution.code, language: @solution.language, problem_id: @solution.problem_id, user_id: @solution.user_id, validity: @solution.validity } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { code: @solution.code, language: @solution.language, problem_id: @solution.problem_id, user_id: @solution.user_id, validity: @solution.validity } }
