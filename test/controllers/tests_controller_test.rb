...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { input: @test.input, output: @test.output, problem_id: @test.problem_id } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { input: @test.input, output: @test.output, problem_id: @test.problem_id } }
