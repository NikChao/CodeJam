...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { end: @competition.end, name: @competition.name, start: @competition.start } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { end: @competition.end, name: @competition.name, start: @competition.start } }
